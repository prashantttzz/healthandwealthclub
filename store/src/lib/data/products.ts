    ...
    .fetch<{ products: HttpTypes.StoreProduct[]; count: number }>(
      `/store/products`,
      {
        ...
        query: {
          ...
          region_id: region?.id,
          fields:
            "*variants.calculated_price,+variants.inventory_quantity,+variants.manage_inventory,*variants.images,*options,*options.values,+metadata,+tags,*categories,*collection",
          ...queryParams,
        },
        headers,
        next,
