...
const FEATURES = [
  ...
  },
  {
    ...
    description: "UAE delivery within 1 to 2 business days. Other GCC countries within 5 to 7 business days. International delivery within 7 to 10 business days."
  },
  {
